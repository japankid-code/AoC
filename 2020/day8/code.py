...
# borrowed from https://github.com/Akumatic/Advent-of-Code/blob/master/2020/08/code.py :)
# just typing out and leaving some notes
# 
...
def run(instructions: list) -> tuple:
    ...
    while pointer not in visited and pointer != size:
        ...
        else: # instructions[pointer][1] == "nop":
            pointer += 1
